...
import {insertChord,chordParts,addRepeatToSelection} from './chords.js';import {parse,serialize} from './format.js';
...
test('selected lines become one explicit repeat block',()=>assert.equal(addRepeatToSelection('A\nB\n\nC',0,3,2),'[Repeat:2]\nA\nB\n[/Repeat:2]\n\nC'));
